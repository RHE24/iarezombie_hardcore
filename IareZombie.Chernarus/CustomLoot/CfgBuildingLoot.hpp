...
class CfgBuildingLoot {
	...
	class Office: Default {
		...
		lootType[] = {
			...
			{"","trash",0.21},
			{"Binocular","weapon",0.02},
			{"ItemBriefcaseEmpty","magazine",0.03}
	...
	class Industrial: Default {
		...
		lootType[] = {
			...
			{"WeaponHolder_ItemHatchet_DZE","object",0.04},
	...
	class IndustrialFuel: Default {
		...
		lootType[] = {
			...
			{"PartVRotor","magazine",0.01},
			{"ItemJerrycan","magazine",0.04},
			{"WeaponHolder_ItemHatchet_DZE","object",0.02},
	...
	class Military: Default {
		...
		lootType[] = {
			...
			{ "assaultrifles", "cfglootweapon", 0.06 },
			{ "sniperrifles", "cfglootweapon", 0.02 },
	...
	class MilitaryIndustrial: Default {
		...
		lootType[] = {
			...
			{"","generic",0.35},
			{"","military",0.07},
			{"ItemEtool","weapon",0.10},
			{"ItemSandbag","magazine",0.10},
			{"ItemFuelBarrelEmpty","magazine",0.03},
			{"fuel_pump_kit","magazine",0.06},
