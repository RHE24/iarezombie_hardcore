...
if (!isDedicated) then {
    ...
    call compile preprocessFileLineNumbers "scripts\player_murderMenu.sqf";
	...
	local_zombieDamage = 			compile preprocessFileLineNumbers "dayz_code\compile\fn_damageHandlerZ.sqf";		//Generated by the client who created a zombie to track damage
	...
	player_medMorphine =			compile preprocessFileLineNumbers "dayz_code\medical\publicEH\medMorphine.sqf";
