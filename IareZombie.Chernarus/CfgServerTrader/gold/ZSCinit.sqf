...
call compile preprocessFileLineNumbers "CfgServerTrader\gold\player_traderMenu.sqf";

BIS_fnc_numberDigits = compile preprocessFileLineNumbers "CfgServerTrader\compiles\numberDigits.sqf";
BIS_fnc_numberText = compile preprocessFileLineNumbers "CfgServerTrader\compiles\numberText.sqf"; 
SC_fnc_removeCoins = compile preprocessFileLineNumbers "CfgServerTrader\compiles\SC_fnc_removeCoins.sqf";
SC_fnc_addCoins = compile preprocessFileLineNumbers "CfgServerTrader\compiles\SC_fnc_addCoins.sqf";

/*overwrites*/
if( isNil "ZSC_Overwrite_SelfActions" || ZSC_Overwrite_SelfActions)then{
fnc_usec_selfActions = compile preprocessFileLineNumbers "CfgServerTrader\compiles\fn_selfActions.sqf";
};
if( isNil "ZSC_Overwrite_SwitchModel" || ZSC_Overwrite_SwitchModel)then{
player_switchModel = compile preprocessFileLineNumbers "CfgServerTrader\compiles\player_switchModel.sqf";
};


if( isNil "ZSC_Overwrite_LockVault" || ZSC_Overwrite_LockVault)then{
player_lockVault =			compile preprocessFileLineNumbers "CfgServerTrader\compiles\player_lockVault.sqf";
};

if( isNil "ZSC_Overwrite_UnLockVault" || ZSC_Overwrite_UnLockVault)then{
player_unlockVault =			compile preprocessFileLineNumbers "CfgServerTrader\compiles\player_unlockVault.sqf";
};
	

player_gearSet	=	compile preprocessFileLineNumbers "CfgServerTrader\compiles\player_gearSet.sqf";
