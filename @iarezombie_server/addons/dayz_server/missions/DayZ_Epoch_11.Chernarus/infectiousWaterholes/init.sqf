...
_t = 0;
_activeArray = [];
diag_log [ diag_tickTime, __FILE__, "Spawing infectious waterholes..."];
{
	if ((random 1) < 0.5) then {
		call compile preprocessFileLineNumbers ("\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\infectiousWaterholes\"+_x+".sqf");
