...
DZAI_WestTypes = ["USMC_Soldier","CDF_Commander","CDF_Soldier_Crew","RUS_Commander" ];
DZAI_ResistanceTypes = ["RU_Worker4", "RU_Woodlander1", "Citizen1", "RU_Priest", "RU_Rocker3", "RU_Profiteer2"];
