...
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["76561198080809662","0","0"]; //do not have a , at the end.//76561198080809662
/*  BANNED PLAYER HERE    */ _BLOCKED =         ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "I are Zombie"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "OverPoch"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "www.iaregameplayer.com"; //do not use " in this text.
...
/*  DebugMonitor Action   */ _DMW = true;	/* true or false */	/* "Debug" option on mousewheel */
